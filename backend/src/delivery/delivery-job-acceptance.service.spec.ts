...
import { DeliveryJobStatus, RiskActorType, RiskCategory } from '@prisma/client';
import { DeliveryJobAcceptanceService } from './delivery-job-acceptance.service';

describe('DeliveryJobAcceptanceService', () => {
  let service: DeliveryJobAcceptanceService;
  let prismaMock: any;
  ...
  beforeEach(() => {
    ...
    service = new DeliveryJobAcceptanceService(
      prismaMock,
  ...
  it('rejects runners without active payment onboarding', async () => {
