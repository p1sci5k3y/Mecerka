 ...
 */
export function canTransitionOrder(current: DeliveryStatus, next: DeliveryStatus): boolean {
    ...
    const validTransitions: Record<DeliveryStatus, DeliveryStatus[]> = {
        ...
        [DeliveryStatus.CONFIRMED]: [DeliveryStatus.READY_FOR_ASSIGNMENT, DeliveryStatus.CANCELLED],
        [DeliveryStatus.READY_FOR_ASSIGNMENT]: [DeliveryStatus.ASSIGNED, DeliveryStatus.CANCELLED],
